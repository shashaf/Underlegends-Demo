...
function lemike_attack6(){
	...
	var _spawn_x3 = obj_battle_manager.x - obj_battle_manager.border_width - 200;
	var _spawn_x4 = obj_battle_manager.border_right + obj_battle_manager.border_width + 300;
	var _spawn_x5 = obj_battle_manager.x - obj_battle_manager.border_width - 400;
	...
	var _spawn_x9 = obj_battle_manager.x - obj_battle_manager.border_width - 800;
	var _spawn_x10 = obj_battle_manager.border_right + obj_battle_manager.border_width + 900;
	var _spawn_x11 = obj_battle_manager.x + obj_battle_manager.border_width - 1000;
