...
with (dialogue_bubble) {
	if other.dialogue_current == 0 or other.dialogue_current == 4 or (other.dialogue_current >= 7 and 
	other.dialogue_current <= 11) or (other.dialogue_current >= 47 and other.dialogue_current <=48) or 
	(other.dialogue_current >= 50 and other.dialogue_current <= 57) or (other.dialogue_current >= 70 and 
	other.dialogue_current <= 89) {
