...
if global.language == "rus" {
	dialogue[0] = "* На этих табличках будет\n  написан сюжет этой главы.";
	dialogue[1] = "* До тех пор, пока у меня нет графики.";
	dialogue[2] = "* Never gonna give you up!~\n* Never gonna let you down!";
	dialogue[3] = "* Вау...~\n* Очень смешно.";
	dialogue[4] = "* Ок, ладно.";
	dialogue[5] = "* Вы знали, что можете\n  показать весь текст,~\n  нажав на X?";
	dialogue[6] = "* Попробуйте это с этим\n  более длинным, чем\n  необходимо сообщением.";
	dialogue[7] = "* Да, и клавиша Z тоже\n  работает так же!";
	dialogue_end = 7;
	if global.enough != 0 {
		dialogue[0] = "* Неважно.";
		dialogue_end = 0;
