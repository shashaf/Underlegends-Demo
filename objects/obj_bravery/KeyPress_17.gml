...
if in_battle == false and (!instance_exists(obj_npc) or (instance_exists(obj_npc) and obj_npc.in_dialogue = false)) and in_cutscene == false and taking_item == false and !instance_exists(obj_item_action) and !instance_exists(obj_save_window) and reading == false {
	if in_menu = false {
		can_move = false;
